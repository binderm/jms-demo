...
@Named
@Dependent
public class SharedDurableTopicOrderReceiver implements OrderReceiver {
    @Inject
    ...
    public Optional<Order> nextOrder() {
        try (JMSConsumer consumer = jmsContext.createSharedDurableConsumer(newOrders, "billing")) {
